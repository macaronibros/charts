(function ($) {
   ...
   * Init
   */
  charts_vertical_bar.init = function () {
    ...
    if ($wrappers.length > 0) {
      ...
      $.each($wrappers, function (index, element) {
        ...
        charts_vertical_bar.createWidget(endpoint, $canvas, index);
  ...
  charts_vertical_bar.createWidget = function (url, $canvas, index) {
    ...
    $.get({
      ...
      function (data) {
        ...
        if (data.data.hasOwnProperty('unit')) {
          charts_vertical_bar.setUnit(data);
        }

        charts_vertical_bar.setCustomLegend(data);
   ...
   * data from endpoint
   */
  charts_vertical_bar.setUnit = function (data) {
   ...
   * data from endpoint
   */
  charts_vertical_bar.setCustomLegend = function (data) {
   ...
   * @private
   */
  charts_vertical_bar._isMobile = function () {
